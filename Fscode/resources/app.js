(function ($) {
    ...
    $.fn.orgChart.defaults = {
        data: [{ id: 1, name: 'Root', parent: 0, hierarchy: 0 }],
        showControls: false,
        allowEdit: false,
        onAddNode: null,
        onDeleteNode: null,
...
var testData = [
    ...
    { id: 1, name: 'FS CODE', parent: 0 },
    { id: 2, name: 'Front-end', parent: 1 },
    { id: 3, name: 'Back-end', parent: 1 },
    { id: 4, name: 'SMM', parent: 1 },
    { id: 6, name: 'Marketing', parent: 1 },
    { id: 7, name: 'Graphic design', parent: 1 },
    { id: 8, name: 'UI/UX Design', parent: 1 },
    { id: 5, name: 'Employee', parent: 3 },
    { id: 10, name: 'Employee', parent: 2 },
    { id:11, name: ' Practitioner', parent: 10 },
    { id:12, name: ' Practitioner', parent: 10 },
